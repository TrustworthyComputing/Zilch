...
class ALU_RAREAD_Gadget : public ALU_Component_Gadget{
private:
	ALU_RAREAD_Gadget(ProtoboardPtr pb, const ALUInput& inputs, const ALUOutput& results);
	virtual void init();
...
public:
	...
	DISALLOW_COPY_AND_ASSIGN(ALU_RAREAD_Gadget);
};
