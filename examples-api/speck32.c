...
void speck32_decrypt(const uint16_t ct[2], uint16_t pt[2], const uint16_t K[ROUNDS]) {
    pt[0] = ct[0];
    pt[1] = ct[1];
    for (int i = 0; i < ROUNDS; i++) {
